...
responseCol <- "class" #el shapefile debe contener un único campo con nombre "class"

trainData

#extracción de valores de pixel en las áreas de entrenamiento
...
#reducción de la muestra a 1000
...
##############################################################################################################################
#BLOQUE 8: ENTRENAMIENTO DEL MODELO Y PREDICCIÓN MEDIANTE RANDOM FOREST (RF)
##############################################################################################################################
...
plot(prediccion_RF500, main = "Predicción RanfomForest 500")



##############################################################################################################################
#BLOQUE 9: ENTRENAMIENTO DEL MODELO Y PREDICCIÓN MEDIANTE SUPPORT VECTOR MACHINE (SVM)
##############################################################################################################################
